...
class JoloBankTest extends BaseTest
{
	...
	public function test_jolo_api_create_new_agent()
	{
		$result = $this->jolo_bank->create(new JoloAgent([
			'phone' 	=> '6290342363',
			'name'		=> 'shek muktar',
			'email' 	=> 'gainacs@gmail.com',
			'address' 	=> 'H.No-25/2, N.C. Road, Kankinara, P.O.-Kankinara, PIN-743126, West Bengal',
		]));
	...
	public function test_jolo_api_create_new_beneficiary_for_registered_agent()
	{
		$result = $this->jolo_bank->create(new JoloBeneficiary([
			'phone' 				=> '6290342363',		/* regd. agent phone number */
			'beneficiary_name'		=> 'sunny chaudhary',
	...
	public function test_jolo_api_verify_transfer_was_successful()
	{
		$result = $this->jolo_bank->verify('transfer', [
			'txn' 				=> 'A201903261899962522',	/* transaction # came as res */
		]);
	...
	{
		$result = $this->jolo_bank->verify('transfer', [
			'txn' 				=> 'B201903261899962522',	/* transaction # came as res */
		]);
...
$test = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test3 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
// TEST #3 : test_jolo_api_verify_new_agent
echo "TEST #3: test_jolo_api_verify_new_agent: ";
$test3->test_jolo_api_verify_new_agent();

$test4 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test5 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test6 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test7 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test8 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test9 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
// TEST #9 : test_jolo_api_verify_transfer_was_successful
echo "TEST #9: test_jolo_api_verify_transfer_was_successful: ";
$test9->test_jolo_api_verify_transfer_was_successful();

$test10 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test11 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test12 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test13 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test14 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
...
$test15 = new JoloBankTest(new JoloBank(new Phurl, $api_key = "205256825787787", 0));
